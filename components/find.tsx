...
function Find() {
  return (
    <section className='flex flex-col items-center justify-center'>
        <h1 className='text-4xl my-20'>How to find the ESG score of a company?</h1>
        <h2 className='text-center'>
            <span className='text-xl mb-6'>Use the Free ESG Score search widget of IMPAKTER INDEX.</span>
            <br />
